...
export default {
  ...
  'fruitsList': ['manzana', 'banano', 'pera', 'naranja', 'fresa', 'kiwi', 'piña', 'mango', 'limon', 'mamon', 'melocoton', 'aguacate'],
});

    let selectVector = ref(categoriesList.value['fruitsList'])
  ...
  let selectedCategory = 'fruitsList'; // Por defecto, seleccionar de 'fruitsList'
